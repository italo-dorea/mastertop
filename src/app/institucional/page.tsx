      ...
      <main className="flex-grow">
        <section className="bg-gradient-to-r from-mastertop-blue/10 via-slate-50/80 to-mastertop-gold/15 backdrop-blur-md border-b border-slate-200/50 pt-64 pb-20 text-center">
          <div className="max-w-4xl mx-auto px-4">
            <h1 className="text-4xl md:text-5xl font-heading font-medium mb-6 bg-gradient-to-r from-mastertop-blue via-slate-800 to-mastertop-gold bg-clip-text text-transparent animate-fade-in-up">Quem Somos</h1>
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-3xl font-heading font-bold mb-6 bg-gradient-to-r from-mastertop-blue via-slate-800 to-mastertop-gold bg-clip-text text-transparent animate-fade-in-up">
                  Nossa História
                </h2>
                <div className="space-y-4 font-sans text-slate-700 text-lg leading-relaxed">
        ...
        <section id="missao" className="py-20 bg-slate-50/80 backdrop-blur-md border-y border-slate-200/50 scroll-mt-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl font-heading font-bold bg-gradient-to-r from-mastertop-blue via-slate-800 to-mastertop-gold bg-clip-text text-transparent animate-fade-in-up">
                Diretrizes Estratégicas
              </h2>
              <p className="text-slate-600 font-sans mt-4 animate-fade-in-up delay-100">
                Os pilares fundamentais que norteiam nossas decisões diárias e projetos futuros.
              </p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white/80 border border-slate-200/80 p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow animate-scale-in">
                <div className="w-12 h-12 rounded-xl bg-mastertop-blue/10 flex items-center justify-center text-mastertop-blue mb-6">
                ...
                <h3 className="font-heading font-bold text-xl text-mastertop-dark mb-4">Missão</h3>
              ...
              <div className="bg-white/80 border border-slate-200/80 p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow animate-scale-in delay-100">
                <div className="w-12 h-12 rounded-xl bg-mastertop-blue/10 flex items-center justify-center text-mastertop-blue mb-6">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>
                </div>
                <h3 className="font-heading font-bold text-xl text-mastertop-dark mb-4">Visão</h3>
                <p className="text-slate-600 font-sans text-sm leading-relaxed">
              ...
              <div className="bg-white/80 border border-slate-200/80 p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow animate-scale-in delay-200">
                <div className="w-12 h-12 rounded-xl bg-mastertop-blue/10 flex items-center justify-center text-mastertop-blue mb-6">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
                </div>
                <h3 className="font-heading font-bold text-xl text-mastertop-dark mb-4">Valores</h3>
                <p className="text-slate-600 font-sans text-sm leading-relaxed">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              <div className="md:order-1">
                ...
                <p className="text-slate-600 font-sans text-lg leading-relaxed mb-6 animate-fade-in-up delay-200">
        ...
        {/* Inovação */}
        <section id="inovacao" className="py-20 bg-slate-50/80 backdrop-blur-md border-y border-slate-200/50 scroll-mt-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div className="rounded-2xl h-96 relative overflow-hidden shadow-lg">
                <img
        ...
        {/* Segurança */}
        <section id="seguranca" className="py-20 bg-transparent scroll-mt-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div className="rounded-2xl h-96 relative overflow-hidden shadow-lg md:order-2">
                <img
                  src="https://images.unsplash.com/photo-1508847154043-be12a62861c1?q=80&w=800&auto=format&fit=crop"
              ...
              <div className="md:order-1">
                <h2 className="text-amber-600 font-subheading text-sm font-bold tracking-widest uppercase mb-3 animate-fade-in-up">Segurança</h2>
                <h3 className="text-3xl font-heading font-bold mb-6 bg-gradient-to-r from-amber-600 to-amber-800 bg-clip-text text-transparent animate-fade-in-up delay-100">
                  Cultura de Acidente Zero
                </h3>
                <p className="text-slate-600 font-sans text-lg leading-relaxed mb-6 animate-fade-in-up delay-200">
                  Para a MASTERTOP, a vida de nossos profissionais é o nosso maior patrimônio. Investimos massivamente em treinamentos de capacitação contínua, auditorias diárias de segurança em canteiros e no fornecimento de equipamentos de ponta para garantir um ambiente produtivo 100% seguro.
                </p>
              </div>
            </div>
          </div>
